...
if isempty(ElecNum)||isnan(ElecNum)||ElecNum==0
    ...
    %         path='/Users/mac/Documents/MATLAB/subjects/wu chuyin/step2/';
...
global ElecInfo_cell ElecInfo_cell2 ElecInfo_table
[filename,pathname]=uiputfile('*.txt','Export the information of all contacts to an TXT format file');
if filename~=0
    f=waitbar(0,'The information of all contacts is being exported to an TXT format file, please be patient...');
    ...
    filename1=[pathname,filename,'_ContactInformation.txt'];
    ...
    ElecInfo_table=cell2table(ElecInfo_cell,'VariableNames',note1);

    waitbar(0.8,f);
    writetable(ElecInfo_table,filename1,'Delimiter',' ');
    waitbar(1,f);
    close(f);
end
